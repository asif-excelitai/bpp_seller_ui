import 'package:bpp_seller_ans/utils/helpers/helper_function.dart';
    ...
    return Container(
      ...
      child:GridView.builder(
          ...
          itemBuilder: (BuildContext context,int index){
            return InkWell(
              onTap: (){
                SHelperFunctions.navigateToScreen(context, ProductsDetailsItem(productType: hotDealsList[index]));
              },
              child: Card(
